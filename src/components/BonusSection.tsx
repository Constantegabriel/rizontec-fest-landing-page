  ...
  return (
    <section id="bonus" className="py-16 bg-gradient-to-r from-slate-900 to-rizontec-dark text-white">
      <div className="section-container">
          ...
          {bonuses.map((bonus, index) => (
            ...
            >
              <div className="flex items-center gap-4">
                <div className="text-3xl p-3 bg-gradient-to-br from-slate-700/30 to-slate-800/30 rounded-full min-w-12 h-12 flex items-center justify-center">{bonus.icon}</div>
                <div>
        ...
        <div className="text-center bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm p-6 sm:p-8 rounded-2xl border border-white/10 mt-12 max-w-2xl mx-auto transform transition-all duration-500 hover:shadow-purple-500/20">
          ...
          <Button size="lg" className="btn-primary animate-pulse-glow group transform transition-all duration-300 hover:translate-y-[-4px] w-full sm:w-auto">
